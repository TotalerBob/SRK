        ...
        return (
          ...
          <div className="dashboard-wrapper">
            <div className="category-header">
              <div style={{ backgroundImage : "url(./src/img/kategorien/hilfe_fuer_familien_in_der_schweiz.jpg)",width: "100%",height:"100%",backgroundSize:"cover",backgroundPosition:"0 30%"}}>
                <div className="category-opacity">
                  <div className="category-title font-bold">Hilfe für Familien in der Schweiz</div>
                  </div>
                  </div>
            </div>
